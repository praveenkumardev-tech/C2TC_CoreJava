...
public class ArrayClassDemo {
	...
	public static void main(String[] args) {
		...
		//Print the key corresoponding index
		...
		System.out.println("Integer Arraus: " + Arrays.toString(intArr2));
		...
		System.out.println("Integer Arrays on filling 22: " + Arrays.toString(intArr));
	}
